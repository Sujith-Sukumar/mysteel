          ...
          >
            ...
            <div className="text-center mb-20 space-y-6">
              <motion.div
                ...
                className="inline-block rounded-full bg-red-50 px-5 py-1.5 text-xs font-bold uppercase tracking-[0.2em] text-red-600"
              >
                Who We Are
              </motion.div>
              <motion.h1
                variants={itemVariants}
                className="text-3xl font-black leading-tight text-gray-900 md:text-5xl tracking-tight"
              >
                Building Stronger Industries with <br />
                <span className="text-red-600">Responsible Trading</span>
              </motion.h1>
              <motion.div
                variants={itemVariants}
            ...
            <div className="flex flex-col items-center gap-16 lg:flex-row">
              ...
              >
                <div className="space-y-6 text-xl leading-relaxed text-gray-600">
                  <p className="font-medium text-gray-800 border-l-4 border-red-600 pl-6">
                    <span className="font-black text-gray-900 uppercase tracking-tighter">My Steel</span> is a premier metal and plastic scrap trading enterprise based in INDIA. We bridge the gap between waste and production through expert recycling.
                  </p>

                  <div className="flex items-start gap-5 group pl-7">
                    <div className="mt-1 h-3 w-3 flex-shrink-0 rounded-full bg-red-600 shadow-[0_0_15px_-2px_rgba(220,38,38,0.5)]" />
                    <p>Specializing in <span className="font-bold text-gray-900">Iron Scrap</span> as a vital raw material for TMT steel production.</p>
                  </div>

                  <div className="flex items-start gap-5 group pl-7">
                    <div className="mt-1 h-3 w-3 flex-shrink-0 rounded-full bg-red-600 shadow-[0_0_15px_-2px_rgba(220,38,38,0.5)]" />
                    <p>Vast network across the <span className="font-bold text-gray-900">GCC region</span> ensuring domestic and international quality standards.</p>
                  </div>
                </div>

                <div className="flex flex-wrap gap-4 pt-4 pl-7">
                  <button className="group relative overflow-hidden rounded-xl bg-red-600 px-10 py-5 font-black text-white shadow-xl transition-all hover:bg-neutral-900 hover:shadow-2xl active:scale-95">
