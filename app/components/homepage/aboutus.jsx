...
export default function AboutUs() {
    ...
    const images = ["/img/iron-scrap.jpeg", "/img/scrapyard.png", "/img/construction-materials.png", "/img/truck-collection.webp"];
                                ...
                                <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2 z-20">
                                    {images.map((_, index) => (
                                        <button
                                            ...
                                            className={`h-2.5 rounded-full transition-all duration-300 ${currentImageIndex === index
                                                    ? "w-8 bg-primary"
