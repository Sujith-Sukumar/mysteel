              ...
              <div className="flex flex-col h-full p-6">
                ...
                <div className="space-y-5 px-4 mb-8">
                  ...
                  <div className="space-y-3.5">
                    <a href="tel:+918281033673" className="flex items-center gap-3 text-white/60 hover:text-white transition-colors">
                      <Phone size={14} className="text-red-500" />
                      <span className="text-xs font-medium">+91 82810 33673</span>
                    </a>
